      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: #0d1f42; padding: 24px; border-radius: 8px 8px 0 0;">
            <h2 style="color: white; margin: 0;">Payroll<span style="color: #f59e0b;">Pro</span></h2>
            <p style="color: #94a3b8; margin: 4px 0 0;">Payroll Notification System</p>
          </div>
          <div style="background: #f8fafc; padding: 24px; border-radius: 0 0 8px 8px;">
            ...
            <p style="color: #94a3b8; font-size: 12px;">This is an automated notification from PayrollPro system.</p>
          </div>
        </div>
      `,
    });
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f8fafc; padding: 24px; border-radius: 0 0 8px 8px;">
            ...
            <hr style="border: none; border-top: 1px solid #e2e8f0; margin: 20px 0;" />
            <p style="color: #94a3b8; font-size: 12px;">This is an automated notification from PayrollPro. Please do not reply to this email.</p>
          </div>
        </div>
      `,
    });
